...
def customer_Data(invoice,sales_invoice_doc):
            try:
                ...
                # if(not customer_doc.tax_id or customer_doc.tax_id == "null" or customer_doc.tax_id == "None"):
                ...
                #     frappe.log_error("LHDN requires proper Contact No." \
                #     "Please fill in the Contact No in customer address")
                #     return
