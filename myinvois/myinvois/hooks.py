...
override_doctype_class = {
	"Sales Invoice": "myinvois.myinvois.cancel_invoice.CancelInvoice"
}
...
# app_include_js = "/assets/myinvois/js/myinvois_lhdn_authorizations.js?v=1.0.1"
